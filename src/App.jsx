...
function App() {
  ...
  const [theme, setTheme] = useState(nighthawkTheme);
    ...
    <div className="w-full h-screen relative">
        ...
        <Qui 
            ...
            cannedQuestions={[
              ...
              "How was the final market value calculated?", 
              "Are there any improvements in the property?",
              "What adjustments were made to the market value?"]}            
        />              
    </div>
  )
}
